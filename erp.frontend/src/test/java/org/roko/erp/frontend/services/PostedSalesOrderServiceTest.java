...
public class PostedSalesOrderServiceTest {
    ...
    public void setup() {
        ...
        svc = new PostedSalesOrderServiceImpl(restTemplateMock);
    }
    ...
    public void get_callsBackend() {
        ...
        verify(restTemplateMock).getForObject("/api/v1/postedsalesorders/{code}", PostedSalesDocumentDTO.class,
                TEST_CODE);
    }
    ...
    public void listWithPage_callsBackend() {
        ...
        verify(restTemplateMock).getForObject("/api/v1/postedsalesorders/page/{page}", PostedSalesDocumentList.class,
                TEST_PAGE);
    }
