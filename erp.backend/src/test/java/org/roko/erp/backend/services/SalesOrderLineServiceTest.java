...
public class SalesOrderLineServiceTest {
    ...
    private static final BigDecimal TEST_PRICE = new BigDecimal(123.23);
    private static final BigDecimal TEST_QUANTITY = new BigDecimal(23.00);
    private static final BigDecimal TEST_AMOUNT = new BigDecimal(23.34);
