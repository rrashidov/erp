...
public class VendorControllerTest {
    ...
    public void setup() {
        ...
        when(svcMock.list(TEST_NAME)).thenReturn(Arrays.asList(vendorMock));
    ...
    public void list_returnsProperValue() {
        VendorList list = controller.list(null);
    ...
    @Test
    public void listWithName_returnsProperValue() {
        VendorList list = controller.list(TEST_NAME);
